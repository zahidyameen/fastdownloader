...
import com.example.fastdownloader.request.DownloadRequestBuilder;
...
public class PRDownloader {
     ...
     */
    public static DownloadRequestBuilder download(Context context,String url,  String fileName) {
        return new DownloadRequestBuilder(context ,url,  fileName);
    }
