...
public class DownloadRequestBuilder implements RequestBuilder {
    ...
    public DownloadRequestBuilder(Context context,String url, String fileName) {
        this.url = url;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            this.dirPath = SetFolderForGreaterThanLollipop(context).getAbsolutePath();
        } else {
            this.dirPath = SetFolderForLessThanLollipop().getPath();
        }
