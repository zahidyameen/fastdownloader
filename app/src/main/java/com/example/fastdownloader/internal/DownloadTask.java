...
import com.example.fastdownloader.handler.ProgressHandler;
import com.example.fastdownloader.httpclient.HttpClient;
import com.example.fastdownloader.internal.stream.FileDownloadOutputStream;
import com.example.fastdownloader.internal.stream.FileDownloadRandomAccessFile;
                ...
                progressHandler
                        .obtainMessage(Constants.UPDATE,
                                new Progress(request.getDownloadedBytes(),
                                        totalBytes,
                                        request.getReceivedBytes())).sendToTarget();
            }
        }
    }
