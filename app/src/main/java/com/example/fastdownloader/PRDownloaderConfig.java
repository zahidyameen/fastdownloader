...
import static com.example.fastdownloader.utils.Utils.FolderName;
import static com.example.fastdownloader.utils.Utils.SetFolderForGreaterThanLollipop;
import static com.example.fastdownloader.utils.Utils.SetFolderForLessThanLollipop;

import android.content.Context;
import android.os.Build;
import android.os.Environment;

import com.example.fastdownloader.httpclient.DefaultHttpClient;
...
public class PRDownloaderConfig {
    ...
    public static class Builder {
        ...
        public  Builder setFolder(Context context) {
            File path;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                path = SetFolderForGreaterThanLollipop(context);
            } else {
                path = SetFolderForLessThanLollipop();
            }
            if ( !path.exists()) {
                path.mkdir();
            }
